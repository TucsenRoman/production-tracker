  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-5 py-10 bg-canvas">
      <div className="w-full max-w-xs">
        ...
        <a
          href="/company" className="mt-3 flex items-center justify-center gap-1.5 text-xs font-medium text-ink-3 hover:text-ink hover:underline transition-colors"
        >
